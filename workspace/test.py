...
db_infer.build('/data-nbd/lxh/DeepBlueAI_Face3/detector/dbface.onnx', 'dbface.trt', 32)
...
def detect(torch_image, scale=1.0):
    ...
    hm, hm_pool, box, landmark  = dbface.inference(torch_image)
    hm = torch.Tensor(hm)
...
if __name__ == '__main__':
    ...
    # torch_image = imread("/data-nbd/lxh/other/DBFace-master/datas/12_Group_Group_12_Group_Group_12_728.jpg")
